<script setup>
import { getGodosDetail } from '@/api/goods'
import { ref } from 'vue'
...
async function getDetail() {
  const res = await getGodosDetail(route.params.id)
...
function addCart() {
  if (skuObj.skuId) {
    cartStore.addCart({
      ...
      picture: list.value.mainPictures[0],
    ...
    <div class="container" v-if="list.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <el-breadcrumb-item
            :to="{ path: `/category/${list.categories[0].parent.id}` }"
            >{{ list.categories[0].parent.name }}
          </el-breadcrumb-item>
          <el-breadcrumb-item
            :to="{ path: `/category/sub/${list.categories[0].id}` }"
            >{{ list.categories[0].name }}</el-breadcrumb-item
          >
      ...
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <XtxImageView :imageList="list.mainPictures"></XtxImageView>
              <!-- 统计数量 -->
            ...
            <div class="goods-article">
              ...
              <div class="goods-tabs">
                ...
                <div class="goods-detail">
                  ...
                  <!-- 图片 -->
                  <img
                    v-for="img in list.details.pictures"
                    :src="img"
                    :key="img"
                    alt=""
                  />
